    ...
    <div class="container mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1">
          <div class="flex items-center mb-4">
            <svg class="h-8 w-8 text-primary-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M2 22l10-10 10 10M15 6.5l-3-3-8.5 8.5 3 3M17 4l3 3"></path>
              <path d="M15.5 7.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"></path>
            </svg>
            <span class="ml-2 text-xl font-display font-bold text-white">CampSpot</span>
          </div>
          <p class="text-neutral-300 mb-4">Discover and book cool camping spots with just a few clicks.</p>
      ...
      <div class="border-t border-neutral-700 mt-8 pt-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-neutral-400 text-sm mb-4 md:mb-0">&copy; {{ new Date().getFullYear() }} CampSpot. All rights reserved.</p>
